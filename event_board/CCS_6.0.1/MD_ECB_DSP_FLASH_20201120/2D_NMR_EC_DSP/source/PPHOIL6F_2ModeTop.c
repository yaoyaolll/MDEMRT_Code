...
void PPHOIL6F_2ModeTop(void)
{
	...
	EchoNum	= 23+6*PPHOIL6F_2NRept123456C;   // 119
	...
	// PPHOIL6F_2_TE_1B=100 PPHOIL6F_2Ne1B=8
...
// PPHOIL6F_2_TE_2B=50 PPHOIL6F_2Ne2B=16
...
// PPHOIL6F_2_TE_3B=70 PPHOIL6F_2Ne3B=11
	Tes	= (Uint32)100*PPHOIL6F_2_TE_3B * FPGA_COUNT;
	Tel	= Tes;
	Ne	= PPHOIL6F_2Ne3B;
...
// PPHOIL6F_2_TE_246A=4 PPHOIL6F_2Ne246A=750
	Tes	= (Uint32)100*PPHOIL6F_2_TE_246A * FPGA_COUNT;
	Tel	= Tes;
	Ne	= PPHOIL6F_2Ne246A;
	EchoStorAddr += 2*PPHOIL6F_2Ne3B;
...
// PPHOIL6F_2_TE_123456C=4 PPHOIL6F_2Ne12346C=25
	Tes	= (Uint32)100 * PPHOIL6F_2_TE_123456C * FPGA_COUNT;
	Tel	= Tes;
	Ne	= PPHOIL6F_2Ne12346C;
	EchoStorAddr += 2*PPHOIL6F_2Ne246A;
...
// PPHOIL6F_2_TE_5B=36 PPHOIL6F_2Ne5B=33
...
// PPHOIL6F_2_TE_4B=8 PPHOIL6F_2Ne4B=250
...
// PPHOIL6F_2_TE_6B=15 PPHOIL6F_2Ne6B=100
...
// PPHOIL6F_2_TE_123456C=4 PPHOIL6F_2Ne5C=50
	Tes	= (Uint32)100 * PPHOIL6F_2_TE_123456C * FPGA_COUNT;
	Tel	= Tes;
	Ne	= PPHOIL6F_2Ne5C;
	EchoStorAddr += 2*PPHOIL6F_2Ne5B;
...
// PPHOIL6F_2_TE_6B=15 PPHOIL6F_2Ne6B=100
	...
	PulseF180StoreAddr++;
	PulseL180StoreAddr++;
	DCWorkOnce(PPHOIL6F_2FreqSelAry[6]);   // echo addr: 0x122C1E, offset: 11294
