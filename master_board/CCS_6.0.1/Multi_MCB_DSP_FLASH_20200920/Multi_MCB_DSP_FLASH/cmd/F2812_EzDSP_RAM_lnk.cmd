...
PAGE 0 :
   ...
   RAM_H0      : origin = 0x3f8002, length = 0x002000
...
PAGE 1 : 
   ...
   RAMM1    : origin = 0x09C00, length = 0x000400
   ...
   DatRcvZone1 : origin = 0x100000, length = 0x020000
   DatRcvZone2 : origin = 0x120000, length = 0x020000
}
...
/*** Uninitialized Sections ***/
    ...
    .sysmem         : > RAMM1       	PAGE = 1
    .cio            : > RAMM1       	PAGE = 1
    my_rev1         : > RAMM1,          PAGE = 1
   	my_rev2         : > RAMM1,          PAGE = 1


/*** Initialized Sections ***/
  	.cinit			: > RAM_H0,  		PAGE = 0    /* Run section from RAM */


	.const			: > RAM_H0,  		PAGE = 0


	.econst			: > RAM_H0,  		PAGE = 0

	.pinit			: > RAM_H0,  		PAGE = 0

	.switch			: > RAM_H0,  		PAGE = 0

	.text			: > RAM_H0,  		PAGE = 0

	ramfuncs	    : > RAM_H0,  		PAGE = 0
